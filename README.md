...
{
for (int i = 0; i < len; i++) out[i] = in[i] ^ key[i % strlen(key)]; out[len]
= 0;
}
int main()
{
...
<img width="615" height="357" alt="image" src="https://github.com/user-attachments/assets/5ad093d0-e124-4e23-83f4-7e0335c10736" />
